...
void VelVulkan::createImageViews() {
	...
	for (size_t i = 0; i < swapChainImages.size(); i++) {
		...
		// use the images as color targets
...
void VelVulkan::createRenderPass() {
	...
	colorAttachment.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR; // clear the framebuffer to black before drawing
	colorAttachment.storeOp = VK_ATTACHMENT_STORE_OP_STORE; // store the rendered contents
...
void VelVulkan::createPipelineLayout() {
...
void VelVulkan::createGraphicsPipeline() {
	auto pipelineConfig = VelVulkanPipeline::defaultPipelineConfigInfo(swapChainExtent);

	graphicsPipeline = std::make_unique<VelVulkanPipeline>(
		device,
		pipelineConfig,
		"shaders/simple_shader.vert.spv",
		"shaders/simple_shader.frag.spv");

	graphicsPipeline->create(pipelineLayout, renderPass);
}

void VelVulkan::createFrameBuffers() {
...
void VelVulkan::createCommandPool() {
...
void VelVulkan::createCommandBuffer() {
...
void VelVulkan::createSyncObjects() {
...
void VelVulkan::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
